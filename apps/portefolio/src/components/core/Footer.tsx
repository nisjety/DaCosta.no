...
const Footer = () => {
  ...
  return (
    <footer className="py-8 border-t border-gray-900" style={{ 
      backgroundColor: 'rgb(var(--footer-bg))', 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link href="/" className="text-xl font-bold">
              DaCosta<span className="text-gray-300">.</span>no
            </Link>
          </div>
          ...
          <div className="text-sm text-gray-400">
            &copy; {currentYear} Ima Da Costa. Alle rettigheter reservert.
          </div>
        </div>
      </div>
    </footer>
